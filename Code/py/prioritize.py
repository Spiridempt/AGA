...
def bboxPrioritization(name, prog, v, ctype, k, n, r, b, repeats, selsize):
    ...
    print 'starting bboxPrioritization ...'
    fin = "../Input_Data/input_adjlist/{}_{}/{}-{}.txt".format(prog, v, prog, ctype)
    if javaFlag:
        fault_matrix = "../Input_Data/input_adjlist/{}_{}/fault_matrix.pickle".format(prog, v)
    else:
        fault_matrix = "../Input_Data/input_adjlist/{}_{}/fault_matrix_key_tc.pickle".format(prog, v)
    outpath = "../Results/compareresults/{}_{}/".format(prog, v)
    ...
    if name == "FAST-" + selsize.__name__[:-1]:
        if ("{}-{}.tsv".format(name, ctype)) not in set(os.listdir(outpath)):
            ...
            for run in xrange(repeats):
                ...
                print "  Running time: " + str(stime) + ' - ' + str(ptime)
                if javaFlag:
...
def wboxPrioritization(name, prog, v, ctype, n, r, b, repeats, selsize):
    print 'starting wboxPrioritization ...'
    javaFlag = True if v == "v0" else False
    ...
    if name == "GT":
        ...
        if ("{}-{}.tsv".format(name, ctype)) not in set(os.listdir(outpath)):
            ...
            for run in xrange(repeats):
                print " Run", run
                stime, ptime, prioritization = competitors.gaf(fin)
                writePrioritization(ppath, name, ctype, run, prioritization)
                apfd = metric.apfd(prioritization, fault_matrix, javaFlag)
                apfds.append(apfd)
                stimes.append(stime)
...
if __name__ == "__main__":
    ...
    prog_vs = {"flex_v3", "grep_v3", "gzip_v1", "make_v1", "sed_v6",
	       ...
	       "ranker_0107","mixer_0106","commonsmath_v1"}
    '''
    ...
    directory = "../Results/compareresults/{}_{}/".format(prog, v)
